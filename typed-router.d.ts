...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'customer-details-id': RouteRecordInfo<'customer-details-id', '/customer/details/id', Record<never, never>, Record<never, never>>,
    'customer-list': RouteRecordInfo<'customer-list', '/customer/list', Record<never, never>, Record<never, never>>,
    'customer-oil-sample': RouteRecordInfo<'customer-oil-sample', '/customer/oil-sample', Record<never, never>, Record<never, never>>,
    'customer-view-customer-bio-panel': RouteRecordInfo<'customer-view-customer-bio-panel', '/customer/view/CustomerBioPanel', Record<never, never>, Record<never, never>>,
    'customer-view-ecommerce-add-customer-drawer': RouteRecordInfo<'customer-view-ecommerce-add-customer-drawer', '/customer/view/ECommerceAddCustomerDrawer', Record<never, never>, Record<never, never>>,
    'customer-view-placed-samples': RouteRecordInfo<'customer-view-placed-samples', '/customer/view/PlacedSamples', Record<never, never>, Record<never, never>>,
    'customer-view-preview-sample-dialog': RouteRecordInfo<'customer-view-preview-sample-dialog', '/customer/view/PreviewSampleDialog', Record<never, never>, Record<never, never>>,
    ...
    'front-navbar': RouteRecordInfo<'front-navbar', '/front/navbar', Record<never, never>, Record<never, never>>,
    'front-samples-list': RouteRecordInfo<'front-samples-list', '/front/samples/list', Record<never, never>, Record<never, never>>,
    ...
    'labs-details-id': RouteRecordInfo<'labs-details-id', '/labs/details/id', Record<never, never>, Record<never, never>>,
    'labs-list': RouteRecordInfo<'labs-list', '/labs/list', Record<never, never>, Record<never, never>>,
    'labs-view-add-test-values-dialog': RouteRecordInfo<'labs-view-add-test-values-dialog', '/labs/view/AddTestValuesDialog', Record<never, never>, Record<never, never>>,
    'labs-view-change-range': RouteRecordInfo<'labs-view-change-range', '/labs/view/ChangeRange', Record<never, never>, Record<never, never>>,
    'labs-view-change-value': RouteRecordInfo<'labs-view-change-value', '/labs/view/ChangeValue', Record<never, never>, Record<never, never>>,
    'labs-view-enter-results': RouteRecordInfo<'labs-view-enter-results', '/labs/view/EnterResults', Record<never, never>, Record<never, never>>,
    ...
    'sales-details-id': RouteRecordInfo<'sales-details-id', '/sales/details/id', Record<never, never>, Record<never, never>>,
    ...
    'techs-details-id': RouteRecordInfo<'techs-details-id', '/techs/details/id', Record<never, never>, Record<never, never>>,
    'techs-list': RouteRecordInfo<'techs-list', '/techs/list', Record<never, never>, Record<never, never>>,
    'techs-view-change-range': RouteRecordInfo<'techs-view-change-range', '/techs/view/ChangeRange', Record<never, never>, Record<never, never>>,
    'techs-view-change-value': RouteRecordInfo<'techs-view-change-value', '/techs/view/ChangeValue', Record<never, never>, Record<never, never>>,
    'techs-view-enter-results': RouteRecordInfo<'techs-view-enter-results', '/techs/view/EnterResults', Record<never, never>, Record<never, never>>,
    'techs-view-leave-comment-dialog': RouteRecordInfo<'techs-view-leave-comment-dialog', '/techs/view/LeaveCommentDialog', Record<never, never>, Record<never, never>>,
